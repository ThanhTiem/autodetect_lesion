...
def main():
    ...
    image = cv2.imread("./data/P_00502_LEFT_CC_FULL.jpg")
    labelsPath="obj.names"
    cfgpath="cfg/yolov3_nocrop.cfg"
    wpath="weights/yolov3_nocrop.weights"
    ...
    res = cv2.resize(res,(600,800))
    # res = cv2.resize(res,(1000,1200))
    cv2.imshow("Image", res)
    cv2.imshow("crop",res_crop)
    cv2.waitKey(0)
